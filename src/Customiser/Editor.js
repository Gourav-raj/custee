...
//minicolors and tooltip import karke unka code comment out krna pdega niche!!!!!
        ...
        <div className="row">			
          <div className="span3">
            ...
            <ul className="nav nav-tabs">
              <li className="active"><a href="#tab1" data-toggle="tab">T-Shirt Options</a></li>				    
              <li><a href="#tab2" data-toggle="tab">Add Images</a></li>
            </ul>
